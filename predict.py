...
if os.path.exists("./web/public/data/forecast.csv"):
    os.remove("./web/public/data/forecast.csv")

df = pd.read_csv('./analysis/dailyStats.csv')
dfx=df['datetime']
dfy=df["new_cases"]
raw_y=dfy.to_numpy()
y=dfy
...
fh = open("./web/public/data/forecast.csv", "a")
